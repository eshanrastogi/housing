...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            #Creating Independent and Dependent feature W.R.T Train and Test
            ...
            logging.info("Pre Processor Pickle file Saved")
            ...
            logging.info("Expection occured in the Initate Data Transformation")
